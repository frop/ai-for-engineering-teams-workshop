        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-wrap gap-4">
            {mockCustomers.map((customer) => (
              <CustomerCard key={customer.id} customer={customer} onSelect={() => {}} />
            ))}
          </div>
        </div>
      );
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-4">
      ...
      <div className="space-y-8">
        ...
        <section className="bg-blue-50 dark:bg-blue-950 rounded-lg p-6">
          <h3 className="text-lg font-semibold text-blue-900 dark:text-blue-200 mb-2">Ready to Start Building?</h3>
